...
function averageTestScore(testScores) {
  ...
  for (var i = 0; i < testScores.length; i++)
    testAverage += testScores[i];

  testAverage = testAverage/testScores.length;
  return testAverage;
}
...
function sumUserPostLikes(user) {
  ...
  //within user object, access posts array
    //cycle through posts array and access each object's 'likes' property
      //total those
...
function addCalculateDiscountPriceMethod(storeItem) {
  ...
  storeItem.calculateDiscountPrice = function () {
    return this.price - (this.discountPercentage * this.price);
  };
  return storeItem;
